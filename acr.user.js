...
const MSGS = [
    ...
    ["Hi, $name. Unfortunately, your account request on the Scratch Wiki couldn't be approved because you didn't read https://en.scratch-wiki.info/wiki/S:CONTRIB completely before requesting. If you think you did read it or have other questions, read https://en.scratch-wiki.info/wiki/S:WHYREJECT for some answers. This decision is final and you'll need to request again if you still want an account. You'll be able to request again in about a week or two.", "yes"],
    ["Hi, $name. Thanks for your Scratch Wiki account request! You did well, pointing out flaws - and you even got the secret word, well done! But you forgot the second part. The S:CONTRIB page says to suggest two things to add to the flawed article, from two different categories. I didn't see those anywhere in the request. So could you give me those suggestions here? Then you should be good to go. Thanks!", "yes"],
    ["Hi there, $name. Thanks for your Scratch Wiki account request, and thank you for pointing out those flaws and suggesting those things to add! But thing is, there's one last thing you missed. The S:CONTRIB page says to add a special something so we know you read the page. Could you tell me what that is? Then you should be good to go. Thanks!", "yes"],
